...
export default function LoginForm () {
  ...
  return (
    <form 
        action={formAction}
        className="relative z-0 bg-[url('/splash-image.jpg')] bg-cover bg-center h-screen w-screen flex flex-col justify-center items-center">
        <div className="absolute z-10 top-24 bg-black opacity-50 w-[100%] h-[75%] transform rotate-45"></div>
        <div className="text-white text-[36px] z-20">
            <h2>Log ind</h2>
        </div>
        <div className="w-[75%] h-[5%] z-20">
            <label>
        ...
        <div className="pt-[0.5em] w-[75%] h-[6%] z-20">
            <label>
        ...
        <div className="w-[75%] h-[5%] ml-[4em] z-20">
            <button type="submit" className="bg-[#5E2E53] text-white text-[18px] rounded-md  mt-[1em] w-[75%] h-[100%]">Log Ind</button>
        </div>
    </form>
  )
}